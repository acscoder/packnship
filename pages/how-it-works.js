...
function HIWPage({ data }) {
  ...
  return (
    <>
    <section id="main-content" className="xl:h-full min-h-full text-white sm:p-10 p-5">
        <div className="border-4 border-black xl:min-h-full relative">
          
        <Header slogan={data.page.slogan} sloganColor="white"/>
            ...
            <div className="container w-fit lg:w-full lg:mx-auto mx-6 min-h-[300px]">
                <div className="lg:grid grid-cols-2 lg:my-16 my-8">
                    ...
                    <div className="sm:text-2xl text-xl font-regular mt-6 sm:block hidden" id="hiw_menu">
                        <div className="sm:w-[500px]"><button data-index="0" data-color="green"  className="hiw_menu_item group h-20 w-full inline-flex items-center border-b-[3px] border-black text-left hover:bg-green-700 transition-colors"><strong className="ml-6 mr-8 text-green-800 group-hover:text-white number">01</strong><span className="sm:w-56 leading-none">Picking & First Mile</span></button></div>
                        <div className="sm:w-[500px]"><button data-index="1" data-color="yellow" className="hiw_menu_item group h-20 w-full inline-flex items-center border-b-[3px] border-black text-left hover:bg-green-700 transition-colors"><strong className="ml-6 mr-8 text-green-800 group-hover:text-white number">02</strong><span className="sm:w-56 leading-none">Kommissionieren & Verpacken</span></button></div>
                        <div className="sm:w-[500px]"><button data-index="2" data-color="orange" className="hiw_menu_item group h-20 w-full inline-flex items-center border-b-[3px] border-black text-left hover:bg-green-700 transition-colors"><strong className="ml-6 mr-8 text-green-800 group-hover:text-white number">03</strong><span className="sm:w-56 leading-none">Versenden</span></button></div>
                        <div className="sm:w-[500px]"><button data-index="3" data-color="teal" className="hiw_menu_item group h-20 w-full inline-flex items-center border-b-[3px] border-black text-left hover:bg-green-700 transition-colors"><strong className="ml-6 mr-8 text-green-800 group-hover:text-white number">04</strong><span className="sm:w-56 leading-none">Retourenmanagement</span></button></div>
                    </div>    
                </div>
                    
                <div className="col-span-1 sm:block hidden">
                    <div className="hiw_item sm:py-0 py-10" id="hiw_item_0">
                    ...
                    <div className="hiw_item sm:hidden block sm:bg-none bg-yellow-600 sm:py-0 py-10" id="hiw_item_1">
                    ...
                    <div className="hiw_item sm:hidden block sm:bg-none bg-orange-600 sm:py-0 py-10" id="hiw_item_2">
                    ...
                    <div className="hiw_item sm:hidden block sm:bg-none bg-teal-600 sm:py-0 py-10" id="hiw_item_3">
  ...
  <div className="hiw_item_mobile bg-green-600 sm:p-10 p-5 sm:hidden block h-full h-full-block" >
    <div className="border-4 border-black h-full">
        <div className="my-5"><img src="/images/mobile/img-01.png"/></div>
        <div className="max-w-2xl sm:px-0 px-6">
            <div className="inline-flex items-center text-2xl mb-2"><strong className="mr-4 text-green-800 bold">01</strong><h3 className=" text-white">Picking & First Mile</h3></div>
            <p className="text-black">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Drum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis</p>
        </div>
    </div>
</div>
...
<div className="hiw_item_mobile bg-orange-600 sm:p-10 p-5 sm:hidden block h-full h-full-block">
    <div className="border-4 border-black h-full">
    <div className="my-5"><img src="/images/mobile/img-03.png"/></div>
    <div className="max-w-2xl sm:px-0 px-6">
    
        <div className="inline-flex items-center text-2xl mb-2"><strong className="mr-4 text-orange-800 bold">03</strong><h3 className=" text-white">Versenden</h3></div>
        <p className="text-black">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Drum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis</p>
    </div>
</div>
</div>
<div className="hiw_item_mobile bg-teal-600 sm:p-10 p-5 sm:hidden block h-full h-full-block">
    <div className="border-4 border-black h-full">
    <div className="my-5"><img src="/images/mobile/img-04.png"/></div>
    <div className="max-w-2xl sm:px-0 px-6">
      
        <div className="inline-flex items-center text-2xl mb-2"><strong className="mr-4 text-teal-800 bold">04</strong><h3 className=" text-white">Retourenmanagement</h3></div>
        <p className="text-black">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Drum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis</p>
    </div>
</div>
</div>
