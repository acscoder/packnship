        ...
        <Header slogan={data.slogan} sloganColor={data.slogan_color}/>
            ...
            <div className="container w-fit lg:w-full lg:mx-auto mx-6 min-h-[300px]">
                <div className="lg:grid grid-cols-2 lg:my-16 my-8">
                    ...
                    <h2 className="xl:text-6xl text-3xl font-light mb-2 mt-10 sm:mt-0">{data.title}</h2>
...
export async function getStaticProps(context) {
    ...
    const res_data = await fetch(process.env.NEXT_PUBLIC_WORDPRESS_DATA_URL+"/"+context.locale+"/how-it-works.json")
