          ...
          return ( 
            ...
            <div className="grid md:grid-cols-3 gap-5 mt-5">
              {job_group.length && job_group.map(function(job,index){
                return (
              <div className={job.url?"col-span-1 border-[3px] p-5 border-black text-base hover:bg-coriander-700 transition-colors":"sm:col-span-2 col-span-1 border-[3px] p-5 border-black text-base hover:bg-coriander-700 transition-colors"} key={"job_"+index}>  
                  <div>     
